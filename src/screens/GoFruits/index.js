            ...
            <View style={styles.homeBody}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={{flexDirection: 'row',justifyContent:'space-between', marginBottom: 15}}>
                        <Text style={{fontSize:20}}>GoFruits</Text>
                        <TouchableOpacity >
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 15 }}>
                        <TouchableOpacity onPress={()=>{navigation.navigate('FruitsShopList')}} style={{ flex: 1 }}>
                            <View style={styles.cardViewf}>
                                <Image style={styles.imagef} source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ868djAR5mIlAFnnjF---4paarCg48aQTr-g&usqp=CAU' }} />
                                <View style={styles.textViewf}>
                                    <Text style={styles.itemTitlef}>Apple</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>{navigation.navigate('FruitsShopList')}} style={{ flex: 1 }}>
                            <View style={styles.cardViewf}>
                                <Image style={styles.imagef} source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTB4q4zrweADrJOAQNSkV9TLqBZBdfGAe3Dpg&usqp=CAU' }} />
                                <View style={styles.textViewf}>
                                    <Text style={styles.itemTitlef}>Blackberry</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 15 }}>
                        <TouchableOpacity onPress={()=>{navigation.navigate('FruitsShopList')}} style={{ flex: 1 }}>
                            <View style={styles.cardViewf}>
                                <Image style={styles.imagef} source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqWXu4Jhjc6A8wn1U7kzWi7CUhze3dAJJebA&usqp=CAU' }} />
                                <View style={styles.textViewf}>
                                    <Text style={styles.itemTitlef}>Pineapple</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>{navigation.navigate('FruitsShopList')}} style={{ flex: 1 }}>
                            <View style={styles.cardViewf}>
                                <Image style={styles.imagef} source={{ uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQU1Q-6ITap5cCPMbzdbgUdk7NW9ag0ckMQUg&usqp=CAU' }} />
                                <View style={styles.textViewf}>
                                    <Text style={styles.itemTitlef}>Banana</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <Text style={{ fontWeight: 'bold', marginVertical: 10 }}>Stores Arround You</Text>
